...
export const Clock = ({ size = 24, className = "", strokeWidth = 2 }: IconProps) => (
  <svg
...
export const MessageCircle = ({ size = 24, className = "", strokeWidth = 2 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Phone = ({ size = 24, className = "", strokeWidth = 2 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const Instagram = ({ size = 24, className = "", strokeWidth = 2 }: IconProps) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
